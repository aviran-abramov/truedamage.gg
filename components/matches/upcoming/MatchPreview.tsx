  ...
  return (
    <li>
      ...
      <Link href={`/matches/${match.id}`}>
        ...
        <MatchPreviewHeader
          gameIconPath={
            match.game.iconUrl ? match.game.iconUrl : "/icons/x.png"
          }
...
const MatchPreviewContent = ({ teamA, teamB }: MatchPreviewContentProps) => {
  const teamAflagUrl =
    teamA.countryCode !== "unknown"
      ? `https://flagcdn.com/w20/${teamA.countryCode}.png`
      : "/icons/flags/unknown.png";
  const teamBflagUrl =
    teamB.countryCode !== "unknown"
      ? `https://flagcdn.com/w20/${teamB.countryCode}.png`
      : "/icons/flags/unknown.png";
  ...
  return (
    <div className="rounded-none text-black dark:text-white text-sm bg-[#F1F1F5] dark:bg-[#191921] grid grid-cols-[1fr_auto_1fr] items-center p-4 gap-4">
      ...
      <p className="text-black dark:text-[#7B7E89] font-extrabold text-2xl">
        VS
      </p>
