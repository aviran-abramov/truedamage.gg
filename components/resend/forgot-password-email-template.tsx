...
export const ForgotPasswordEmail = ({ username }: ForgotPasswordEmailProps) => (
  <Html>
    <Head />
    {/* <Tailwind config={tailwindConfig}> */}
    <Tailwind>
      <Body className="bg-white text-[#24292e] font-github">
        <Preview>TrueDamage.gg password recovery</Preview>
        <Container className="max-w-120 mx-auto my-0 pt-5 pb-12 px-0">
          ...
          <Section className="p-6 border border-solid border-[#dedede] rounded-[5px] text-center">
            ...
            <Text className="mb-2.5 mt-0 text-left">
              We received a reqest to change your password. If you did not
              request the password change, please ignore this message.
            </Text>
